...
import { FiSliders, FiMic, FiCheckSquare, FiActivity, FiUser, FiFile, FiFileText, FiSettings, FiLogOut, FiCpu, FiCode, FiLayers, FiAward, FiCalendar, FiEdit3, FiCompass } from 'react-icons/fi';
    ...
    <aside className="sidebar-container">
      ...
      <div>
        ...
        <ul className="sidebar-menu">
          ...
          <li>
            <NavLink to="/scheduler" className={({ isActive }) => isActive ? 'sidebar-item-link active' : 'sidebar-item-link'}>
              <FiCalendar />
        ...
        <ul className="sidebar-menu">
          ...
          <li>
            <NavLink to="/career-coach" className={({ isActive }) => isActive ? 'sidebar-item-link active' : 'sidebar-item-link'}>
              <FiCompass />
