...
router.post(
  ...
  [
    body('interviewType')
      .isIn(['Technical', 'HR', 'Mixed', 'ResumeBased', 'Custom', 'FullLoop', 'CompanySpecific'])
      .withMessage('Interview type must be Technical, HR, Mixed, ResumeBased, Custom, FullLoop, or CompanySpecific'),
    body('role')
      .notEmpty()
